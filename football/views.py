...
def predict_match(request, match_id):
    ...
    # Check if user has a valid payment for this sport within the last 24 hours
    valid_payment = UserSportPayment.get_valid_payment(request.user, match.sport)
    has_paid_for_match_date = valid_payment is not None

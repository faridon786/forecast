...
from .models import Team, Match, Prediction, Profile, Payment, Sport, TermsOfService, WithdrawalRequest, ContactMessage, UserSportPrediction
...
class MatchAdmin(admin.ModelAdmin):
    list_display = ('match_name', 'date', 'sport', 'is_finished', 'home_team_score', 'away_team_score')

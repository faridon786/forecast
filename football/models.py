...
class Profile(models.Model):
    ...
    def get_referral_link(self):
        """Get the full referral link for the user"""
        ...
        if request and isinstance(request, HttpRequest):
            return request.build_absolute_uri(f"/register?ref={self.referral_code}")
...
class Prediction(models.Model):
    ...
    def check_prediction(self):
        ...
        if (self.home_team_score == self.match.home_team_score and 
            self.away_team_score == self.match.away_team_score):
